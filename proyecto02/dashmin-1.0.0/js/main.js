...
function CargarDatos(){
   ...
   xhr.onreadystatechange = function(){
    ...
    xhr.open("GET", "cr/datos.xml", true);
    xhr.send();
}
...
function cargarXML(xml){
   ...
   var tabla = "<tr><th>ESTADO</th><th>numeroAutorizacion</th><th>fechaAutorizacion</th><th>ambiente</th></tr>";
   ...
   for(var i = 0; i<factura.length; i++){
       ...
       tabla += "</td><td>";
       tabla += factura[i].getElementsByTagName("ambiente")[0].textContent;
       tabla += "</td></tr>";
   }
...
function CargarDatos2(){
    ...
    .then((quotes) => {
        ...
        document.getElementById('respuesta').innerHTML = JSON.stringify(quotes);    
        }
    );
